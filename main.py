...
if choice == 'Home':
    ...
    option_3_s, option_4_s = st.multiselect(' ', ['History', 'Investments', 'Healthcare', 'Robotics', 'Companies', 'Market&Clients', 'Research', 'Education', 'Enterprises', 'Legality'], default=['Education', 'Legality'])
